...
export const credentials: Credential[] = [
  ...
  { id: 'cr-1',  subjectUserId: 'u-1', issuerUserId: 'u-admin',      credentialType: 'identity',     title: 'NIDA Verified Identity',           claim: { nida: 'NIDA-1234-5678', verified: true },          proofHash: 'sha256:abc001', confidence: 0.98, status: 'active', issuedAt: '2026-02-10' },
  { id: 'cr-2',  subjectUserId: 'u-1', issuerInstitutionId: 'fi-3',  credentialType: 'financial',    title: 'CRDB Bank — Account Standing',     claim: { accountAge: '6y', avgBalance: 'TZS 4.2M' },       proofHash: 'sha256:abc002', confidence: 0.92, status: 'active', issuedAt: '2026-01-20' },
  { id: 'cr-3',  subjectUserId: 'u-1', issuerCompanyId: 'co-1',      credentialType: 'work_history', title: 'Simba Tech — Senior Designer',     claim: { role: 'Senior UX Designer', duration: '2y 3m' },   proofHash: 'sha256:abc003', confidence: 0.95, status: 'active', issuedAt: '2026-02-01' },
  { id: 'cr-4',  subjectUserId: 'u-1', issuerUserId: 'u-2',          credentialType: 'endorsement',  title: 'Joseph Mwangi — Endorsement',      claim: { skill: 'UI/UX Design' },                           proofHash: 'sha256:abc004', confidence: 0.85, status: 'active', issuedAt: '2026-03-01' },
  { id: 'cr-5',  subjectUserId: 'u-1', issuerUserId: 'u-admin',      credentialType: 'skill',        title: 'Figma Certified Professional',     claim: { level: 'Advanced' },                               proofHash: 'sha256:abc005', confidence: 0.90, status: 'active', issuedAt: '2026-01-15' },
  { id: 'cr-6',  subjectUserId: 'u-1', issuerInstitutionId: 'fi-13', credentialType: 'financial',    title: 'M-Pesa — Payment History',         claim: { transactions: 240, reliability: '99.2%' },         proofHash: 'sha256:abc006', confidence: 0.78, status: 'active', issuedAt: '2026-02-20' },
  // Joseph Mwangi (u-2)
  { id: 'cr-7',  subjectUserId: 'u-2', issuerUserId: 'u-admin',      credentialType: 'identity',     title: 'Huduma Namba Verified',            claim: { huduma: 'HN-5678-9012' },                          proofHash: 'sha256:def001', confidence: 0.97, status: 'active', issuedAt: '2026-01-05' },
  { id: 'cr-8',  subjectUserId: 'u-2', issuerInstitutionId: 'fi-5',  credentialType: 'financial',    title: 'Equity Bank Kenya — Account',      claim: { accountAge: '3y' },                                proofHash: 'sha256:def002', confidence: 0.88, status: 'active', issuedAt: '2026-02-14' },
  { id: 'cr-9',  subjectUserId: 'u-2', issuerCompanyId: 'co-3',      credentialType: 'work_history', title: 'Savanna Consulting — Dev Lead',    claim: { role: 'Lead Developer', duration: '1y 6m' },       proofHash: 'sha256:def003', confidence: 0.90, status: 'active', issuedAt: '2026-03-10' },
  // Fatuma Omar (u-3)
  { id: 'cr-10', subjectUserId: 'u-3', issuerUserId: 'u-admin',      credentialType: 'identity',     title: 'NIDA Verified Identity',           claim: { nida: 'NIDA-7890-1234' },                          proofHash: 'sha256:ghi001', confidence: 0.98, status: 'active', issuedAt: '2026-01-28' },
  { id: 'cr-11', subjectUserId: 'u-3', issuerInstitutionId: 'fi-4',  credentialType: 'financial',    title: 'NMB Bank — Account Standing',      claim: { accountAge: '4y' },                                proofHash: 'sha256:ghi002', confidence: 0.91, status: 'active', issuedAt: '2026-02-08' },
  { id: 'cr-12', subjectUserId: 'u-3', issuerCompanyId: 'co-1',      credentialType: 'work_history', title: 'Simba Tech — Project Manager',     claim: { role: 'Senior PM', duration: '3y', delivered: 12 }, proofHash: 'sha256:ghi003', confidence: 0.94, status: 'active', issuedAt: '2026-03-05' },
  { id: 'cr-13', subjectUserId: 'u-3', issuerUserId: 'u-1',          credentialType: 'endorsement',  title: 'Amina Hassan — Endorsement',       claim: { skill: 'Project Delivery' },                       proofHash: 'sha256:ghi004', confidence: 0.87, status: 'active', issuedAt: '2026-03-15' },
  // Ibrahim Said (u-4) — pending
  { id: 'cr-14', subjectUserId: 'u-4', issuerUserId: 'u-admin',      credentialType: 'identity',     title: 'NIDA Verification (Pending)',      claim: { status: 'under_review' },                          proofHash: 'sha256:jkl001', confidence: 0.50, status: 'pending', issuedAt: '2026-03-01' },
  // Grace John (u-5)
  { id: 'cr-15', subjectUserId: 'u-5', issuerUserId: 'u-admin',      credentialType: 'identity',     title: 'NIDA Verified Identity',           claim: { nida: 'NIDA-2345-6789' },                          proofHash: 'sha256:mno001', confidence: 0.97, status: 'active', issuedAt: '2026-01-10' },
  { id: 'cr-16', subjectUserId: 'u-5', issuerInstitutionId: 'fi-3',  credentialType: 'financial',    title: 'CRDB Bank — Savings Account',      claim: { accountAge: '2y' },                                proofHash: 'sha256:mno002', confidence: 0.85, status: 'active', issuedAt: '2026-02-25' },
  // David Omondi (u-6)
  { id: 'cr-17', subjectUserId: 'u-6', issuerUserId: 'u-admin',      credentialType: 'identity',     title: 'Huduma Namba Verified',            claim: { huduma: 'HN-1111-2222' },                          proofHash: 'sha256:pqr001', confidence: 0.97, status: 'active', issuedAt: '2026-01-18' },
  { id: 'cr-18', subjectUserId: 'u-6', issuerInstitutionId: 'fi-5',  credentialType: 'financial',    title: 'Equity Bank — Account',            claim: { accountAge: '4y' },                                proofHash: 'sha256:pqr002', confidence: 0.90, status: 'active', issuedAt: '2026-02-12' },
  { id: 'cr-19', subjectUserId: 'u-6', issuerCompanyId: 'co-3',      credentialType: 'work_history', title: 'Savanna Consulting — Data Lead',   claim: { role: 'Data Science Lead', duration: '2y' },       proofHash: 'sha256:pqr003', confidence: 0.93, status: 'active', issuedAt: '2026-03-08' },
  { id: 'cr-20', subjectUserId: 'u-6', issuerUserId: 'u-2',          credentialType: 'endorsement',  title: 'Joseph Mwangi — Endorsement',      claim: { skill: 'Machine Learning' },                       proofHash: 'sha256:pqr004', confidence: 0.84, status: 'active', issuedAt: '2026-02-28' },
]
